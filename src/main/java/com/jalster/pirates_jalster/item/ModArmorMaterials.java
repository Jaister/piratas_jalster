...
public enum ModArmorMaterials implements ArmorMaterial {
    MUGIWARA("mugiwara", 37, new int[]{3, 6, 8, 50}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(new ItemLike[]{Items.NETHERITE_INGOT}));
    ...
    public String getName() {
        return PiratesJalster.MOD_ID + ":" + this.name;
    }
